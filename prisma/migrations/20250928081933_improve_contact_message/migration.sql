/*
  ...
  - You are about to drop the column `firstName` on the `ContactMessage` table. All the data in the column will be lost.
...
*/
-- AlterTable
ALTER TABLE "public"."ContactMessage" DROP COLUMN "firstName",
